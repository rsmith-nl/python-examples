#!/usr/bin/env python3
# file: razer-get-fwver.py
# vim:fileencoding=utf-8:fdm=marker:ft=python
#
# Copyright © 2020 R.F. Smith <rsmith@xs4all.nl>.
# SPDX-License-Identifier: MIT
# Created: 2020-03-18T20:45:17+0100
# Last modified: 2022-02-06T16:05:06+0100
"""Get the firmware version from a Razer keyboard.
...
if __name__ == "__main__":
    ...
    logging.debug(
        f"ctrl_transfer(0x{request_type:02x}, 0x{request:02x}, "
        f"0x{value:02x}, 0x{report_index:02x}, 90) = {result}"
    )
    ...
    major = int(arguments[0])
    minor = int(arguments[1])
